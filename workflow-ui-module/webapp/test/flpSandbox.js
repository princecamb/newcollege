		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nwcollegetaskworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nwcollegetaskworkflowuimodule-display": {
								"semanticObject": "nwcollegetaskworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nwcollegetask.workflowuimodule",
									"url": sap.ui.require.toUrl("nwcollegetask/workflowuimodule")
								}
							}
						}
					}
